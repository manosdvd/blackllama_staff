(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=[{id:`checklist-1`,text:`Submit Medical Forms A, B, and C`,category:`HR`},{id:`checklist-2`,text:`Complete Safeguarding Youth Training (SYT)`,category:`Training`},{id:`checklist-3`,text:`Complete online Hazardous Weather module`,category:`Training`},{id:`checklist-4`,text:`Sign the Code of Conduct commitment sheet`,category:`Code`},{id:`checklist-5`,text:`Take the Camp Lawton Certification Quiz`,category:`Quiz`}];function t(){return`
    <div class="dashboard-grid">
      ...
      <div class="welcome-banner-card">
        <div class="welcome-banner-text">
          <h2>${I.username?`Welcome to the Mountain, <span id="dashboard-username">${I.username}</span>! 🌲`:`Welcome to the Mountain! 🌲`}</h2>
      ...
      <div class="wam-alert-card" id="wam-card">
        <div style="display: flex; flex-direction: column; gap: 6px;">
          ...
          <span style="font-size: 13px; font-weight: 700; background: rgba(255,255,255,0.2); padding: 4px 10px; border-radius: 4px; align-self: flex-start; margin-top: 6px;" id="wam-counter-display">Drinks Logged: ${I.wamCount}</span>
        </div>
  ...
  `}function n(){let e=document.getElementById(`dashboard-username`);e&&(e.textContent=I.username);let t=document.getElementById(`dashboard-explore-btn`);t&&t.addEventListener(`click`,()=>X(`schedule`));let n=document.getElementById(`wam-btn`),a=document.getElementById(`wam-card`),o=document.getElementById(`wam-counter-display`);n&&a&&n.addEventListener(`click`,e=>{I.incrementWam();let t=document.createElement(`div`);t.classList.add(`wam-ripple-effect`);let n=a.getBoundingClientRect(),r=e.clientX-n.left,i=e.clientY-n.top;t.style.left=`${r}px`,t.style.top=`${i}px`,a.appendChild(t),setTimeout(()=>t.remove(),1200)}),r(),i();let s=()=>{r(),i()},c=()=>{o&&(o.textContent=`Drinks Logged: ${I.wamCount}`)},l=()=>{window.removeEventListener(`state-tasks-updated`,s),window.removeEventListener(`state-wam-updated`,c),window.removeEventListener(`before-view-change`,l)};window.addEventListener(`before-view-change`,l),window.addEventListener(`state-tasks-updated`,s),window.addEventListener(`state-wam-updated`,c)}function r(){let t=document.getElementById(`dashboard-checklist-mount`);t&&(t.innerHTML=e.map(e=>{let t=I.completedTasks.includes(e.id);return`
...
`);try{t=new Worker(URL.createObjectURL(new Blob([n])))}catch(e){return typeof console<`u`&&typeof console.warn==`function`&&console.warn(`🎊 Could not load worker`,e),null}o(t)}return t}})(),p={particleCount:50,angle:90,spread:45,startVelocity:45,decay:.9,gravity:1,drift:0,ticks:200,x:.5,y:.5,shapes:[`square`,`circle`],zIndex:100,colors:[`#26ccff`,`#a25afd`,`#ff5e7e`,`#88ff5a`,`#fcff42`,`#ffa62d`,`#ff36ff`],disableForReducedMotion:!1,scalar:1};function m(e,t){return t?t(e):e}function h(e){return e!=null}function g(e,t,n){return m(e&&h(e[t])?e[t]:p[t],n)}function _(e){return e<0?0:Math.floor(e)}function v(e,t){return Math.floor(Math.random()*(t-e))+e}function y(e){return parseInt(e,16)}function b(e){return e.map(x)}function x(e){var t=String(e).replace(/[^0-9a-f]/gi,``);return t.length<6&&(t=t[0]+t[0]+t[1]+t[1]+t[2]+t[2]),{r:y(t.substring(0,2)),g:y(t.substring(2,4)),b:y(t.substring(4,6))}}function S(e){var t=g(e,`origin`,Object);return t.x=g(t,`x`,Number),t.y=g(t,`y`,Number),t}function C(e){e.width=document.documentElement.clientWidth,e.height=document.documentElement.clientHeight}function w(e){var t=e.getBoundingClientRect();e.width=t.width,e.height=t.height}function T(e){var t=document.createElement(`canvas`);return t.style.position=`fixed`,t.style.top=`0px`,t.style.left=`0px`,t.style.pointerEvents=`none`,t.style.zIndex=e,t}function E(e,t,n,r,i,a,o,s,c){e.save(),e.translate(t,n),e.rotate(a),e.scale(r,i),e.arc(0,0,1,o,s,c),e.restore()}function D(e){var t=e.angle*(Math.PI/180),n=e.spread*(Math.PI/180);return{x:e.x,y:e.y,wobble:Math.random()*10,wobbleSpeed:Math.min(.11,Math.random()*.1+.05),velocity:e.startVelocity*.5+Math.random()*e.startVelocity,angle2D:-t+(.5*n-Math.random()*n),tiltAngle:(Math.random()*.5+.25)*Math.PI,color:e.color,shape:e.shape,tick:0,totalTicks:e.ticks,decay:e.decay,drift:e.drift,random:Math.random()+2,tiltSin:0,tiltCos:0,wobbleX:0,wobbleY:0,gravity:e.gravity*3,ovalScalar:.6,scalar:e.scalar,flat:e.flat}}function O(e,t){t.x+=Math.cos(t.angle2D)*t.velocity+t.drift,t.y+=Math.sin(t.angle2D)*t.velocity+t.gravity,t.velocity*=t.decay,t.flat?(t.wobble=0,t.wobbleX=t.x+10*t.scalar,t.wobbleY=t.y+10*t.scalar,t.tiltSin=0,t.tiltCos=0,t.random=1):(t.wobble+=t.wobbleSpeed,t.wobbleX=t.x+10*t.scalar*Math.cos(t.wobble),t.wobbleY=t.y+10*t.scalar*Math.sin(t.wobble),t.tiltAngle+=.1,t.tiltSin=Math.sin(t.tiltAngle),t.tiltCos=Math.cos(t.tiltAngle),t.random=Math.random()+2);var n=t.tick++/t.totalTicks,r=t.x+t.random*t.tiltCos,i=t.y+t.random*t.tiltSin,a=t.wobbleX+t.random*t.tiltCos,s=t.wobbleY+t.random*t.tiltSin;if(e.fillStyle=`rgba(`+t.color.r+`, `+t.color.g+`, `+t.color.b+`, `+(1-n)+`)`,e.beginPath(),o&&t.shape.type===`path`&&typeof t.shape.path==`string`&&Array.isArray(t.shape.matrix))e.fill(M(t.shape.path,t.shape.matrix,t.x,t.y,Math.abs(a-r)*.1,Math.abs(s-i)*.1,Math.PI/10*t.wobble));else if(t.shape.type===`bitmap`){var c=Math.PI/10*t.wobble,l=Math.abs(a-r)*.1,d=Math.abs(s-i)*.1,f=t.shape.bitmap.width*t.scalar,p=t.shape.bitmap.height*t.scalar,m=new DOMMatrix([Math.cos(c)*l,Math.sin(c)*l,-Math.sin(c)*d,Math.cos(c)*d,t.x,t.y]);m.multiplySelf(new DOMMatrix(t.shape.matrix));var h=e.createPattern(u.transform(t.shape.bitmap),`no-repeat`);h.setTransform(m),e.globalAlpha=1-n,e.fillStyle=h,e.fillRect(t.x-f/2,t.y-p/2,f,p),e.globalAlpha=1}else if(t.shape===`circle`)e.ellipse?e.ellipse(t.x,t.y,Math.abs(a-r)*t.ovalScalar,Math.abs(s-i)*t.ovalScalar,Math.PI/10*t.wobble,0,2*Math.PI):E(e,t.x,t.y,Math.abs(a-r)*t.ovalScalar,Math.abs(s-i)*t.ovalScalar,Math.PI/10*t.wobble,0,2*Math.PI);else if(t.shape===`star`)for(var g=Math.PI/2*3,_=4*t.scalar,v=8*t.scalar,y=t.x,b=t.y,x=5,S=Math.PI/x;x--;)y=t.x+Math.cos(g)*v,b=t.y+Math.sin(g)*v,e.lineTo(y,b),g+=S,y=t.x+Math.cos(g)*_,b=t.y+Math.sin(g)*_,e.lineTo(y,b),g+=S;else e.moveTo(Math.floor(t.x),Math.floor(t.y)),e.lineTo(Math.floor(t.wobbleX),Math.floor(i)),e.lineTo(Math.floor(a),Math.floor(s)),e.lineTo(Math.floor(r),Math.floor(t.wobbleY));return e.closePath(),e.fill(),t.tick<t.totalTicks}function ee(e,t,n,a,o){var s=t.slice(),c=e.getContext(`2d`),f,p,m=l(function(t){function l(){f=p=null,c.clearRect(0,0,a.width,a.height),u.clear(),o(),t()}function m(){r&&!(a.width===i.width&&a.height===i.height)&&(a.width=e.width=i.width,a.height=e.height=i.height),!a.width&&!a.height&&(n(e),a.width=e.width,a.height=e.height),c.clearRect(0,0,a.width,a.height),s=s.filter(function(e){return O(c,e)}),s.length?f=d.frame(m):l()}f=d.frame(m),p=l});return{addFettis:function(e){return s=s.concat(e),m},canvas:e,promise:m,reset:function(){f&&d.cancel(f),p&&p()}}}function k(e,n){var r=!e,i=!!g(n||{},`resize`),o=!1,s=g(n,`disableForReducedMotion`,Boolean),c=a&&g(n||{},`useWorker`)?f():null,u=r?C:w,d=e&&c?!!e.__confetti_initialized:!1,p=typeof matchMedia==`function`&&matchMedia(`(prefers-reduced-motion)`).matches,m;function h(t,n,r){for(var i=g(t,`particleCount`,_),a=g(t,`angle`,Number),o=g(t,`spread`,Number),s=g(t,`startVelocity`,Number),c=g(t,`decay`,Number),l=g(t,`gravity`,Number),d=g(t,`drift`,Number),f=g(t,`colors`,b),p=g(t,`ticks`,Number),h=g(t,`shapes`),y=g(t,`scalar`),x=!!g(t,`flat`),C=S(t),w=i,T=[],E=e.width*C.x,O=e.height*C.y;w--;)T.push(D({x:E,y:O,angle:a,spread:o,startVelocity:s,color:f[w%f.length],shape:h[v(0,h.length)],ticks:p,decay:c,gravity:l,drift:d,scalar:y,flat:x}));return m?m.addFettis(T):(m=ee(e,T,u,n,r),m.promise)}function y(n){var a=s||g(n,`disableForReducedMotion`,Boolean),f=g(n,`zIndex`,Number);if(a&&p)return l(function(e){e()});r&&m?e=m.canvas:r&&!e&&(e=T(f),document.body.appendChild(e)),i&&!d&&u(e);var _={width:e.width,height:e.height};c&&!d&&c.init(e),d=!0,c&&(e.__confetti_initialized=!0);function v(){if(c){var t={getBoundingClientRect:function(){if(!r)return e.getBoundingClientRect()}};u(t),c.postMessage({resize:{width:t.width,height:t.height}});return}_.width=_.height=null}function y(){m=null,i&&(o=!1,t.removeEventListener(`resize`,v)),r&&e&&(document.body.contains(e)&&document.body.removeChild(e),e=null,d=!1)}return i&&!o&&(o=!0,t.addEventListener(`resize`,v,!1)),c?c.fire(n,_,y):h(n,_,y)}return y.reset=function(){c&&c.reset(),m&&m.reset()},y}var A;function j(){return A||=k(null,{useWorker:!0,resize:!0}),A}function M(e,t,n,r,i,a,o){var s=new Path2D(e),c=new Path2D;c.addPath(s,new DOMMatrix(t));var l=new Path2D;return l.addPath(c,new DOMMatrix([Math.cos(o)*i,Math.sin(o)*i,-Math.sin(o)*a,Math.cos(o)*a,n,r])),l}function N(e){if(!o)throw Error(`path confetti are not supported in this browser`);var t,n;typeof e==`string`?t=e:(t=e.path,n=e.matrix);var r=new Path2D(t),i=document.createElement(`canvas`).getContext(`2d`);if(!n){for(var a=1e3,s=a,c=a,l=0,u=0,d,f,p=0;p<a;p+=2)for(var m=0;m<a;m+=2)i.isPointInPath(r,p,m,`nonzero`)&&(s=Math.min(s,p),c=Math.min(c,m),l=Math.max(l,p),u=Math.max(u,m));d=l-s,f=u-c;var h=10,g=Math.min(h/d,h/f);n=[g,0,0,g,-Math.round(d/2+s)*g,-Math.round(f/2+c)*g]}return{type:`path`,path:t,matrix:n}}function te(e){var t,n=1,r=`#000000`,i=`"Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "Twemoji Mozilla", "system emoji", sans-serif`;typeof e==`string`?t=e:(t=e.text,n=`scalar`in e?e.scalar:n,i=`fontFamily`in e?e.fontFamily:i,r=`color`in e?e.color:r);var a=10*n,o=``+a+`px `+i,s=new OffscreenCanvas(a,a),c=s.getContext(`2d`);c.font=o;var l=c.measureText(t),u=Math.ceil(l.actualBoundingBoxRight+l.actualBoundingBoxLeft),d=Math.ceil(l.actualBoundingBoxAscent+l.actualBoundingBoxDescent),f=2,p=l.actualBoundingBoxLeft+f,m=l.actualBoundingBoxAscent+f;u+=f+f,d+=f+f,s=new OffscreenCanvas(u,d),c=s.getContext(`2d`),c.font=o,c.fillStyle=r,c.fillText(t,p,m);var h=1/n;return{type:`bitmap`,bitmap:s.transferToImageBitmap(),matrix:[h,0,0,h,-u*h/2,-d*h/2]}}n.exports=function(){return j().apply(this,arguments)},n.exports.reset=function(){j().reset()},n.exports.create=k,n.exports.shapeFromPath=N,n.exports.shapeFromText=te})((function(){return typeof window<`u`?window:typeof self<`u`?self:this||{}})(),h,!1);var g=h.exports;h.exports.create;var _=[{id:`zone-parade`,name:`Parade Grounds (Assembly flags)`,type:`emergency`,description:`Central grassy assembly grounds. The main assembly point for all emergency alarms and daily morning/evening flag ceremonies.`,note:`🛎️ If emergency bell rings, report here immediately.`},{id:`zone-dining`,name:`Dining Hall (Primary Lightning Shelter)`,type:`emergency`,description:`Primary dining hall and kitchen. Main indoor space, serves as the designated shelter for severe storms, lightning, and microbursts.`,note:`⚡ Primary lightning shelter. Tents offer zero protection.`},{id:`zone-scoutcraft`,name:`Scoutcraft Area`,type:`program`,description:`Under Area Director Jim Tarleton. Teaching pioneering, wilderness survival, camping, and rope work.`,note:`🗺️ Scoutcraft teaches traditional outdoor skills.`},{id:`zone-handicraft`,name:`Handicraft Area`,type:`program`,description:`Under Area Director Jack Erickson. Teaching woodcarving, basketry, leatherwork, and art.`,note:`🎨 Keep area clean and return all blades/tools to lockers.`},{id:`zone-nature`,name:`Nature Lodge`,type:`program`,description:`Under Area Director Andrew Rasmussen. Teaching astronomy, geology, forestry, environmental science, and reptile study.`,note:`🐍 Non-venomous educational animals housed here.`},{id:`zone-ranges`,name:`Range and Target Activities`,type:`program`,description:`Under Area Director Brian Rome. Archery, rifle, and shotgun ranges.`,note:`🎯 Strictly controlled zones. Suspension under high winds.`},{id:`zone-climbing`,name:`Climbing Wall & Tower`,type:`program`,description:`Under Director Jim Harrington. Rock wall climbing and rappelling training tower.`,note:`🧗 Minimum age of director is 21.`},{id:`zone-staffhill`,name:`Staff Hill (Cabins)`,type:`staff`,description:`North end of camp. Staff quarters, living cabins, and youth/adult staff shower houses.`,note:`🔒 Strictly off-limits to campers. Respect roommate privacy.`},{id:`zone-health`,name:`Health Lodge / Medic Office`,type:`staff`,description:`Medic office and emergency recovery beds. Coordinates first aid, logs injuries, and stores medications.`,note:`🩹 Report all injuries, no matter how minor, immediately.`},{id:`zone-trading`,name:`Trading Post`,type:`staff`,description:`Camp general store and business headquarters. Sells gear, snacks, and souvenirs.`,note:`🎟️ No staff discount or credit tabs. Cash/card only.`}];function v(){return`
  ...
  `}function T(){let e=document.getElementById(`packing-mount`),t=document.getElementById(`packing-progress-val`),n=document.querySelectorAll(`.packing-filter-tab`),r=document.getElementById(`conduct-name-input`),i=document.getElementById(`conduct-sig-input`),o=document.getElementById(`conduct-date-input`),s=document.getElementById(`conduct-agree-chk`),c=document.getElementById(`conduct-sign-btn`);document.getElementById(`conduct-unsign-btn`);let l=document.getElementById(`signer-inputs-panel`),u=document.getElementById(`signer-success-panel`);document.getElementById(`signed-name-val`);let d=document.getElementById(`paperwork-mount`),p=document.getElementById(`paperwork-progress-val`);if(!e)return;let m=JSON.parse(localStorage.getItem(`lawton_packed_items`))||[],h=JSON.parse(localStorage.getItem(`lawton_paperwork_items`))||[];function g(){localStorage.setItem(`lawton_paperwork_items`,JSON.stringify(h)),_()}function _(){if(!p)return;let e=f.paperwork.length;p.textContent=`Done: ${h.length}/${e}`}function v(){d&&(d.innerHTML=f.paperwork.map(e=>{let t=h.includes(e.id);return`
      ...
      `}).join(``),d.querySelectorAll(`.packing-item-card`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-pw-id`),n=h.indexOf(t);n>-1?(h.splice(n,1),e.classList.remove(`packed`)):(h.push(t),e.classList.add(`packed`)),g()})}))}function y(){localStorage.setItem(`lawton_packed_items`,JSON.stringify(m)),b()}function b(){if(!t)return;let e=a.filter(e=>e.status!==`prohibited`).length;t.textContent=`Packed: ${a.filter(e=>e.status!==`prohibited`&&m.includes(e.id)).length}/${e} items`}function x(t=`all`){e.innerHTML=a.filter(e=>t===`all`?!0:e.category===t).map(e=>{let t=e.status===`prohibited`,n=m.includes(e.id);return`
        <div class="packing-item-card ${n&&!t?`packed`:``} ${t?`prohibited`:``}" data-item-id="${e.id}" role="checkbox" aria-checked="${n}">
          <div class="packing-item-checkbox"></div>
          <span class="packing-item-name">${e.name}</span>
        </div>
      `}).join(``),e.querySelectorAll(`.packing-item-card`).forEach(e=>{e.addEventListener(`click`,()=>{let t=e.getAttribute(`data-item-id`),n=a.find(e=>e.id===t);if(n&&n.status!==`prohibited`){let n=m.indexOf(t);n>-1?(m.splice(n,1),e.classList.remove(`packed`)):(m.push(t),e.classList.add(`packed`)),y()}})})}n.forEach(e=>{e.addEventListener(`click`,()=>{n.forEach(e=>e.classList.remove(`active`)),e.classList.add(`active`),x(e.getAttribute(`data-filter`))})});function S(){if(!I.username){l&&(l.style.display=`none`),u&&(u.style.display=`flex`,u.style.borderColor=`hsl(var(--warning))`,u.style.background=`hsl(var(--warning) / 0.1)`,u.innerHTML=`
        ...
        `,document.getElementById(`conduct-login-prompt-btn`).addEventListener(`click`,()=>{document.getElementById(`user-badge`).click()}));return}I.signedConduct?(l&&(l.style.display=`none`),u&&(u.style.display=`flex`,u.style.borderColor=`hsl(var(--success))`,u.style.background=`hsl(var(--success-light) / 0.15)`,u.innerHTML=`
          ...
          <p style="font-size: 13px; line-height: 1.4; margin-bottom: 10px;">
            Thank you, <strong id="signed-name-val">${I.username}</strong>! Your signed Code of Conduct is on file. This task has been marked complete on your readiness checklist.
          </p>
        ...
        `,document.getElementById(`conduct-unsign-btn`).addEventListener(`click`,()=>{I.setSignedConduct(!1),i&&(i.value=``),s&&(s.checked=!1),S()}))):(l&&(l.style.display=`flex`),u&&(u.style.display=`none`),r&&(r.value=I.username),o&&(o.value=new Date().toISOString().split(`T`)[0]))}c&&c.addEventListener(`click`,()=>{let e=i.value.trim(),t=s.checked;if(!e){alert(`Please type your name in the Digital Signature field.`);return}if(!t){alert(`You must check the agreement box to sign the Code of Conduct.`);return}I.setSignedConduct(!0),S()}),x(),v(),b(),_(),S()}function E(){return`
  ...
  `}function ee(){let e=document.getElementById(`quiz-mount`);if(!e)return;let t=0,n=0,r=null,i=[];function a(){let i=l.length,a=l[t],s=t/i*100;e.innerHTML=`
    ...
    `,e.querySelectorAll(`.quiz-option-btn`).forEach(e=>{e.addEventListener(`click`,()=>{r===null&&o(parseInt(e.getAttribute(`data-option-idx`)))})})}function o(a){r=a,i[t]=a;let o=l[t],c=a===o.answerIndex;c&&n++,e.querySelectorAll(`.quiz-option-btn`).forEach((e,t)=>{t===o.answerIndex?e.classList.add(`correct`):t===a&&e.classList.add(`incorrect`),e.disabled=!0});let u=document.getElementById(`quiz-feedback-mount`);u&&(u.style.display=`block`,u.innerHTML=`
      ...
      `);let d=document.getElementById(`quiz-next-bar`);if(d){d.style.display=`flex`;let e=document.getElementById(`quiz-next-btn`);e&&e.addEventListener(`click`,s)}}function s(){r=null,t++,t<l.length?a():c()}function c(){let o=l.length,s=Math.round(n/o*100),c=s>=80;c&&(I.completedTasks.includes(`checklist-5`)||I.toggleTask(`checklist-5`),u());let d=l.filter((e,t)=>i[t]!==e.answerIndex),f=``;f=d.length>0?`
    ...
    `,document.getElementById(`quiz-restart-btn`).addEventListener(`click`,()=>{t=0,n=0,r=null,i=[],a()}),c&&document.getElementById(`quiz-dashboard-btn`).addEventListener(`click`,()=>{X(`dashboard`)})}function u(){let e=4*1e3,t=Date.now()+e,n={startVelocity:30,spread:360,ticks:60,zIndex:1e4};function r(e,t){return Math.random()*(t-e)+e}let i=setInterval(function(){let a=t-Date.now();if(a<=0)return clearInterval(i);let o=a/e*50;g({...n,particleCount:o,origin:{x:r(.1,.3),y:Math.random()-.2}}),g({...n,particleCount:o,origin:{x:r(.7,.9),y:Math.random()-.2}})},250)}a()}function k(){return`
    <div style="display: flex; flex-direction: column; gap: 24px; width: 100%;">
      <!-- Tab Selectors -->
      <div class="schedule-tabs-container">
  ...
  `}function A(){let e=document.getElementById(`training-tab-scouting`),t=document.getElementById(`training-tab-culture`),n=document.getElementById(`training-tab-service`),r=document.getElementById(`training-tab-program`),i=document.getElementById(`training-panel-mount`);if(!i)return;function a(){i.querySelectorAll(`.flip-card`).forEach(e=>{e.addEventListener(`click`,()=>{e.classList.toggle(`flipped`)})})}function o(){e.classList.add(`active`),t.classList.remove(`active`),n.classList.remove(`active`),r.classList.remove(`active`),i.innerHTML=`
    ...
    `}e.addEventListener(`click`,o),t.addEventListener(`click`,c),n.addEventListener(`click`,s),r.addEventListener(`click`,l),o()}var j=0,M=JSON.parse(localStorage.getItem(`camp_lawton_app_draft`))||{};function N(e){e.innerHTML=`
    <div style="max-width: 800px; margin: 0 auto; padding-bottom: 60px;">
      ...
      <div style="display: flex; flex-direction: column; gap: 10px; margin-bottom: 30px;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
          ...
          <span style="font-size: 14px; color: hsl(var(--muted-foreground)); font-weight: 500;">Step ${j+1} of 5</span>
        </div>
        <div style="height: 8px; background: hsl(var(--border)); border-radius: 4px; overflow: hidden; position: relative;">
          <div style="position: absolute; top: 0; left: 0; height: 100%; width: ${j/4*100}%; background: hsl(var(--primary)); transition: width 0.4s ease; border-radius: 4px;"></div>
        </div>
      </div>
      ...
      <div class="glass-panel" style="animation: tabFadeIn 0.4s ease;">
        <form id="application-form" style="display: flex; flex-direction: column; gap: 24px;">
          ...
          <div style="display: flex; justify-content: space-between; margin-top: 20px; border-top: 1px solid hsl(var(--border)); padding-top: 20px;">
            <button type="button" id="app-prev-btn" class="welcome-banner-btn" style="background: hsl(var(--secondary)); color: hsl(var(--foreground)); ${j===0?`visibility: hidden;`:``}">Back</button>
            <button type="button" id="app-next-btn" class="welcome-banner-btn">${j===4?`Sign & Submit`:`Next Section`}</button>
          </div>
        </form>
      </div>
    </div>
  `,te(document.getElementById(`step-content`)),ne()}function te(e){let t=``;switch(j){case 0:t=`
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
          ...
          ${P(`Preferred Name / Nickname`,`nickname`)}
          ${P(`Phone Number`,`phone`,`tel`)}
        </div>
        ${P(`Email Address`,`email`,`email`)}
        ${P(`Primary Address`,`address`)}
        ...
        <select id="ageEligibility" style="padding: 10px; border-radius: var(--radius-sm); border: 1px solid hsl(var(--border)); background: var(--glass-bg); color: hsl(var(--foreground)); width: 100%;">
          ...
          <option value="14" ${M.ageEligibility===`14`?`selected`:``}>14-15 years old (CIT Minimum)</option>
          <option value="16" ${M.ageEligibility===`16`?`selected`:``}>16-17 years old (Junior Staff)</option>
          <option value="18" ${M.ageEligibility===`18`?`selected`:``}>18-20 years old (Adult Status)</option>
          <option value="21" ${M.ageEligibility===`21`?`selected`:``}>21+ years old (Camp Management)</option>
        </select>

        ${F(`workAuth`,`I am legally authorized to work in the United States (Proof required upon hire).`)}
        ${F(`scoutReg`,`I am currently registered with Scouting America OR agree to register if hired.`)}
      `;break;case 1:t=`
        <h3 style="color: hsl(var(--foreground)); margin-bottom: 16px;">Section II: Position Preferences</h3>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
          ${P(`Available Start Date`,`startDate`,`date`)}
          ${P(`Available End Date`,`endDate`,`date`)}
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
          <select id="shirtSize" style="padding: 10px; border-radius: var(--radius-sm); border: 1px solid hsl(var(--border)); background: var(--glass-bg); color: hsl(var(--foreground));">
            ...
            ${[`S`,`M`,`L`,`XL`,`2XL`,`3XL`].map(e=>`<option value="${e}" ${M.shirtSize===e?`selected`:``}>${e}</option>`).join(``)}
          </select>
          <select id="jacketSize" style="padding: 10px; border-radius: var(--radius-sm); border: 1px solid hsl(var(--border)); background: var(--glass-bg); color: hsl(var(--foreground));">
            ...
            ${[`S`,`M`,`L`,`XL`,`2XL`,`3XL`].map(e=>`<option value="${e}" ${M.jacketSize===e?`selected`:``}>${e}</option>`).join(``)}
          </select>
        </div>
      `;break;case 2:t=`
        <h3 style="color: hsl(var(--foreground)); margin-bottom: 16px;">Section III: Experience & References</h3>
        ${P(`Current Scouting Rank (if any)`,`scoutRank`)}
        ${F(`oaMember`,`I am an Order of the Arrow Member`)}
        
        <h4 style="margin-top: 16px; color: hsl(var(--primary));">Previous Employment / Camp Staff</h4>
        ${P(`Most Recent Employer / Camp`,`employer`)}
        ${P(`Primary Duties / Role`,`duties`)}
        
        <h4 style="margin-top: 16px; color: hsl(var(--primary));">Professional References (Need 3)</h4>
        <div style="display: flex; flex-direction: column; gap: 10px;">
          ${P(`Reference 1 (Name, Relation, Contact)`,`ref1`)}
          ${P(`Reference 2 (Name, Relation, Contact)`,`ref2`)}
          ${P(`Reference 3 (Name, Relation, Contact)`,`ref3`)}
        </div>
      `;break;case 3:t=`
        ...
        <div style="display: flex; flex-direction: column; gap: 14px;">
          ${F(`ackAltitude`,`<strong>High-Altitude & Terrain:</strong> I understand this requires physical exertion and navigating rugged terrain.`)}
          ${F(`ackWildlife`,`<strong>Wildlife & Smellables:</strong> I agree to strictly adhere to the camp wildlife protocols.`)}
          ${F(`ackSanitation`,`<strong>Water & Sanitation:</strong> I acknowledge water scarcity, shower limits, and that duties include cleaning latrines.`)}
          ${F(`ackMedical`,`<strong>Medical Clearances:</strong> I must provide a current BSA Annual Health Record (Parts A, B, and C) upon hire.`)}
        </div>
        <h4 style="margin-top: 16px; color: hsl(var(--primary));">Current Certifications</h4>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
          ${F(`certCPR`,`CPR / AED`)}
          ${F(`certWFA`,`Wilderness First Aid`)}
        </div>
      `;break;case 4:t=`
        ...
        ${F(`ackAgreements`,`I agree to the above terms and certify all provided info is accurate.`)}
        
        <div style="margin-top: 20px;">
          ${P(`Digital Signature (Type Full Legal Name)`,`signature`)}
          ${P(`Date`,`sigDate`,`date`)}
        </div>
      `;break}e.innerHTML=t,e.querySelectorAll(`input, select`).forEach(e=>{e.type===`checkbox`?e.checked=M[e.id]||!1:e.value=M[e.id]||``})}function ne(){let e=document.getElementById(`application-form`),t=document.getElementById(`app-prev-btn`),n=document.getElementById(`app-next-btn`);e.addEventListener(`input`,()=>{e.querySelectorAll(`input, select`).forEach(e=>{e.type===`checkbox`?M[e.id]=e.checked:M[e.id]=e.value}),localStorage.setItem(`camp_lawton_app_draft`,JSON.stringify(M))}),t.addEventListener(`click`,()=>{j>0&&(j--,N(document.getElementById(`view-mount-point`)))}),n.addEventListener(`click`,()=>{j<4?(j++,N(document.getElementById(`view-mount-point`))):re()})}function re(){if(!M.signature||!M.ackAgreements){alert(`Please provide a digital signature and check the agreement box before submitting.`);return}localStorage.removeItem(`camp_lawton_app_draft`),M={},j=0;let e=document.getElementById(`view-mount-point`);e.innerHTML=`
  ...
  `}var I={username:localStorage.getItem(`lawton_username`)||``,role:localStorage.getItem(`lawton_role`)||``,completedTasks:[],wamCount:parseInt(localStorage.getItem(`lawton_wam_count`)||`0`),signedConduct:!1,activeView:`dashboard`,setUsername(e){this.username=e,e?localStorage.setItem(`lawton_username`,e):localStorage.removeItem(`lawton_username`),this.loadUserData(e),Y(),window.dispatchEvent(new CustomEvent(`state-tasks-updated`)),window.dispatchEvent(new CustomEvent(`state-conduct-updated`))},setRole(e){this.role=e,e?(localStorage.setItem(`lawton_role`,e),this.username&&localStorage.setItem(`lawton_role_${this.username}`,e)):localStorage.removeItem(`lawton_role`),Y()},toggleTask(e){let t=this.completedTasks.indexOf(e);t>-1?this.completedTasks.splice(t,1):this.completedTasks.push(e),this.username&&localStorage.setItem(`lawton_tasks_${this.username}`,JSON.stringify(this.completedTasks)),window.dispatchEvent(new CustomEvent(`state-tasks-updated`))},incrementWam(){this.wamCount++,localStorage.setItem(`lawton_wam_count`,this.wamCount.toString()),window.dispatchEvent(new CustomEvent(`state-wam-updated`))},setSignedConduct(e){this.signedConduct=e,this.username&&localStorage.setItem(`lawton_conduct_${this.username}`,e?`true`:`false`),window.dispatchEvent(new CustomEvent(`state-conduct-updated`));let t=`checklist-4`,n=this.completedTasks.includes(t);(e&&!n||!e&&n)&&this.toggleTask(t)},loadUserData(e){if(!e){this.completedTasks=[],this.signedConduct=!1,this.role=``;return}this.completedTasks=JSON.parse(localStorage.getItem(`lawton_tasks_${e}`))||[],this.signedConduct=localStorage.getItem(`lawton_conduct_${e}`)===`true`,this.role=localStorage.getItem(`lawton_role_${e}`)||`Staff`},logout(){this.username=``,this.role=``,this.completedTasks=[],this.signedConduct=!1,localStorage.removeItem(`lawton_username`),localStorage.removeItem(`lawton_role`),Y(),window.dispatchEvent(new CustomEvent(`state-tasks-updated`)),window.dispatchEvent(new CustomEvent(`state-wam-updated`)),window.dispatchEvent(new CustomEvent(`state-conduct-updated`))}};I.loadUserData(I.username);var L={dashboard:{title:`Dashboard`,subtitle:`Welcome to the Camp Lawton digital staff portal.`,render:t,init:n},training:{title:`Training & Culture`,subtitle:`Camp Lawton pillars, scouting methods, Disney standards, and program controls.`,render:k,init:A},schedule:{title:`Camp Schedule`,subtitle:`Sunday check-in protocols and daily life schedule.`,render:p,init:m},officemap:{title:`Camp Map & EAP`,subtitle:`Interactive map and emergency evacuation drill simulator.`,render:v,init:y},safetyguides:{title:`Policies & Procedures`,subtitle:`Emergency flowcharts, radio simulator, and legal guidelines.`,render:S,init:C},packing:{title:`Onboarding`,subtitle:`Paperwork checklist, gear lists, and Code of Conduct signer.`,render:w,init:T},songs:{title:`Songbook & Comedy Class`,subtitle:`Rousing logs songs, action cued lyrics, and comedy writing guides.`,render:E,init:D},quiz:{title:`Staff Handbook Quiz`,subtitle:`Complete the training review to get Camp Lawton certified.`,render:O,init:ee},application:{title:`Staff Application 2026`,subtitle:`Apply to join the Catalina Council at Camp Lawton.`,render:N,init:()=>{}}},R,z,B,V,H,U,W,G,K,q,J;function ie(){let e=localStorage.getItem(`lawton_theme`)||(window.matchMedia(`(prefers-color-scheme: dark)`).matches?`dark`:`light`);document.documentElement.setAttribute(`data-theme`,e)}function ae(){let e=document.documentElement.getAttribute(`data-theme`)===`dark`?`light`:`dark`;document.documentElement.setAttribute(`data-theme`,e),localStorage.setItem(`lawton_theme`,e)}function Y(){W&&(W.textContent=I.username||`Guest`),U&&(U.textContent=I.username?I.username.charAt(0).toUpperCase():`?`);let e=L[I.activeView];e&&e.init&&e.init()}function oe(){q&&q.close()}function X(e){let t=L[e];if(!t)return;I.activeView=e,V.forEach(t=>{t.getAttribute(`data-view`)===e?t.classList.add(`active`):t.classList.remove(`active`)});let n=()=>{window.dispatchEvent(new CustomEvent(`before-view-change`)),R.textContent=t.title,z.textContent=t.subtitle,B.innerHTML=t.render(),t.init&&t.init()};document.startViewTransition?document.startViewTransition(n).finished.finally(()=>{R.focus()}):(n(),R.focus())}function se(e){e&&(`closedBy`in HTMLDialogElement.prototype||e.addEventListener(`click`,t=>{if(t.target!==e)return;let n=e.getBoundingClientRect();n.top<=t.clientY&&t.clientY<=n.top+n.height&&n.left<=t.clientX&&t.clientX<=n.left+n.width||e.close()}))}function Z(){return JSON.parse(localStorage.getItem(`lawton_users`)||`[]`)}function ce(e){let t=Z();t.push(e),localStorage.setItem(`lawton_users`,JSON.stringify(t))}var Q=`login`;function $(e=``){let t=document.getElementById(`profile-dialog-content`);if(t)if(!I.username)t.innerHTML=`
      ...
      `}
    `,document.getElementById(`profile-dialog-close`).addEventListener(`click`,()=>K.close()),document.getElementById(`tab-login`).addEventListener(`click`,()=>{Q=`login`,$()}),document.getElementById(`tab-signup`).addEventListener(`click`,()=>{Q=`signup`,$()}),Q===`login`?document.getElementById(`auth-login-submit`).addEventListener(`click`,le):document.getElementById(`auth-signup-submit`).addEventListener(`click`,ue);else{let e=I.completedTasks.length,n=Math.round(e/5*100);t.innerHTML=`
      <button class="dialog-close-btn" id="profile-dialog-close" aria-label="Close dialog">✕</button>
      ...
      <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 20px; background: hsl(var(--secondary) / 0.3); padding: 16px; border-radius: var(--radius-md); border: 1px solid hsl(var(--border));">
        ...
        <div>
          <h4 style="font-size: 18px; margin: 0; color: hsl(var(--foreground));">${I.username}</h4>
          <span style="font-size: 13.5px; color: hsl(var(--accent)); font-weight: 700;">${I.role}</span>
        </div>
      </div>
      ...
      <div style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 24px; font-size: 14.5px;">
        ...
        <div style="display: flex; justify-content: space-between; border-bottom: 1px solid hsl(var(--border) / 0.5); padding-bottom: 8px;">
          ...
          <span style="font-weight: 700;">${I.signedConduct?`✅ Signed`:`❌ Unsigned`}</span>
        </div>
        <div style="display: flex; justify-content: space-between; border-bottom: 1px solid hsl(var(--border) / 0.5); padding-bottom: 8px;">
          <span style="color: hsl(var(--muted-foreground));">Water Logged:</span>
          <span style="font-weight: 700;">🥤 ${I.wamCount} WAMs</span>
        </div>
      </div>
    ...
    `,document.getElementById(`profile-dialog-close`).addEventListener(`click`,()=>K.close()),document.getElementById(`auth-logout`).addEventListener(`click`,()=>{I.logout(),$(),K.close()})}}function le(){let e=document.getElementById(`login-username`),t=document.getElementById(`login-password`);if(!e||!t)return;let n=e.value.trim(),r=t.value;if(!n||!r){$(`Please fill in all fields.`);return}let i=Z().find(e=>e.username.toLowerCase()===n.toLowerCase());if(!i){$(`Username not found. Please sign up!`);return}if(i.password!==r){$(`Incorrect password. Try again.`);return}I.setRole(i.role),I.setUsername(i.username),K.close()}function ue(){let e=document.getElementById(`signup-username`),t=document.getElementById(`signup-password`),n=document.getElementById(`signup-role`);if(!e||!t||!n)return;let r=e.value.trim(),i=t.value,a=n.value;if(!r||!i){$(`Please fill in all fields.`);return}if(r.length<3){$(`Username must be at least 3 characters.`);return}if(Z().some(e=>e.username.toLowerCase()===r.toLowerCase())){$(`Username already taken.`);return}ce({username:r,password:i,role:a}),I.setRole(a),I.setUsername(r),K.close()}document.addEventListener(`DOMContentLoaded`,()=>{R=document.getElementById(`view-title`),z=document.getElementById(`view-subtitle`),B=document.getElementById(`view-mount-point`),V=document.querySelectorAll(`.nav-item`),H=document.getElementById(`theme-toggle`),U=document.getElementById(`user-avatar`),W=document.getElementById(`user-name-display`),G=document.getElementById(`user-badge`),K=document.getElementById(`profile-dialog`),document.getElementById(`profile-dialog-close`),document.getElementById(`profile-name-input`),document.getElementById(`profile-save-btn`),q=document.getElementById(`app-dialog`),J=document.getElementById(`dialog-close`),ie(),Y(),X(`dashboard`),V.forEach(e=>{e.addEventListener(`click`,()=>{X(e.getAttribute(`data-view`))})}),H.addEventListener(`click`,ae),G.addEventListener(`click`,()=>{K&&($(),K.showModal())}),J.addEventListener(`click`,oe),se(q),se(K)});