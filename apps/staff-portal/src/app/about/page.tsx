    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="glass-panel flex flex-col gap-3 bg-white/70 dark:bg-neutral-900/60 p-6">
          ...
          <div className="bg-neutral-100 dark:bg-neutral-800/50 p-4 rounded-xl border border-neutral-200 dark:border-neutral-800 text-xs font-semibold leading-normal text-neutral-800 dark:text-neutral-200">
        ...
        <div className="glass-panel flex flex-col gap-3 bg-white/70 dark:bg-neutral-900/60 p-6">
          ...
          <div className="bg-neutral-100 dark:bg-neutral-800/50 p-4 rounded-xl border border-neutral-200 dark:border-neutral-800 text-xs font-semibold leading-normal flex gap-2 text-neutral-800 dark:text-neutral-200">
            <Landmark size={18} className="text-neutral-400 flex-shrink-0 mt-0.5" />
            <div>
