    ...
    statusHtml = `
      <div class="glass-panel" style="border-color: hsl(var(--warning) / 0.4); background: hsl(var(--warning) / 0.05); padding: 24px; display: flex; flex-direction: column; gap: 12px;">
        ...
        <div style="display:flex; gap:12px; flex-wrap:wrap; margin-top: 8px;">
          <button class="welcome-banner-btn" id="candidate-fill-app-btn" style="font-weight:700;">Start Online Application 💻</button>
          <a href="/downloads/Camp_Lawton_Staff_Application_2026.pdf" download class="glass-btn" style="text-decoration:none; padding:10px 20px; font-weight:600; display:flex; align-items:center; gap:6px; color:inherit;">
            📥 Download Blank PDF Application
          </a>
        </div>

        <div style="margin-top: 14px; background: hsl(var(--secondary) / 0.2); border-left: 3px solid hsl(var(--warning)); padding: 12px; border-radius: var(--radius-sm); font-size: 13px; line-height: 1.4; color: hsl(var(--muted-foreground));">
          <strong>Prefer Paper?</strong> A paper application remains fully acceptable. You can print the blank PDF application above, fill it out by hand, and submit it directly to the Council Scout Office:
          <div style="margin-top: 6px; font-family: monospace; font-size: 12.5px; color: hsl(var(--foreground));">
            Catalina Council, Scouting America<br>
            Attn: Camp Lawton Director<br>
    ...
    statusHtml = `
      <div class="glass-panel" style="border-color: hsl(var(--primary) / 0.4); background: hsl(var(--primary) / 0.03); padding: 24px; display: flex; gap: 16px; align-items: center;">
        ...
        <div>
          ...
          <div style="margin-top: 10px; font-size: 13px; color: hsl(var(--muted-foreground));">
            Need to make changes? You can download the <a href="/downloads/Camp_Lawton_Staff_Application_2026.pdf" download style="color: hsl(var(--primary)); text-decoration: underline;">Blank PDF Application</a>, fill it out, and submit it via paper.
          </div>
        </div>
      </div>
    `;
