    ...
    <div style="display: flex; flex-direction: column; gap: 24px; width: 100%;">
      ...
      <div class="glass-panel" style="padding: 20px; display: flex; flex-direction: column; gap: 16px;">
        <div style="display: flex; flex-direction: column; gap: 4px;">
          ...
          <p style="font-size: 13.5px; color: hsl(var(--muted-foreground)); margin: 0; line-height: 1.5;">
            Meet the team making the magic happen. To safeguard our youth, minors' (under 18) personal details are redacted, showing only their display name and program role. Personal contact details (phone, email, address) are never visible in the public directory.
          </p>
        </div>
      </div>
  ...
  return `
    <div class="glass-panel profile-edit-grid" style="animation: tabFadeIn 0.3s; padding: 24px;">
      ...
      <div style="display: flex; flex-direction: column; gap: 20px;">
        ...
        <div style="background: hsl(var(--secondary) / 0.15); border: 1.5px solid hsl(var(--border) / 0.5); padding: 14px 18px; border-radius: var(--radius-sm); font-size: 13px; line-height: 1.4; color: hsl(var(--muted-foreground));">
          <h4 style="color: hsl(var(--primary)); margin: 0 0 6px 0; font-size: 14px; font-family: var(--font-heading); display:flex; align-items:center; gap:6px;">
            <span>🛡️</span> Digital Privacy & Safeguarding Disclosures
          </h4>
          <ul style="margin: 0; padding-left: 18px; display:flex; flex-direction:column; gap:4px;">
            <li>Your <strong>Phone Number, Email, and Address</strong> are kept strictly confidential and are <em>never</em> visible in the staff directory (visible to camp directors/admins only).</li>
            <li>Hometown, Favorite Song, and Bio are optional. If shared, they are visible to onboarded staff only.</li>
            <li><strong>Minor Staff (Under 18):</strong> Profiles of staff members under 18 are automatically restricted. Only first name and role are displayed in the directory to prevent exposing minor details.</li>
          </ul>
        </div>
